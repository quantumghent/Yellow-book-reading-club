...
\begin{equation}
	...
	\end{aligned}
\end{equation}
where $\frac{1}{2}$ is the particle number density since the field operators are all normal ordered and describing the quantum fluctuations near their corresponding expectation value.\\
