...
\begin{equation}
	\psi_{+}^\dagger \sim e^{i\phi_0} \sim e^{i\frac{1}{2} \left(\varphi_0+\theta_0\right)} \sim e^{i\frac{\varphi}{2R}}e^{i\frac{\theta R}{2}} \sim e^{i\left(\frac{1}{2R}+\frac{R}{2}\right)\phi}e^{i\left(\frac{1}{2R}-\frac{R}{2}\right)\bar{\phi}}
\end{equation} 
...
\noindent {\bf Relevant perturbations and boudary states} \\
...
\end{equation}
 (equivalently $S^x$ or $S^y$).  It pinns down the $\varphi$ field, hence breaks the $U_\varphi (1)$ symmetry. 

 (2) The spin operator 
\begin{equation}
	S^z \sim - \frac{1}{2\pi}\partial_x \theta - \left(-1\right)^x\frac{1}{\pi}\cos (\theta)	
\end{equation}
pinns down the $\theta$ field, hence breaks the $U_\theta (1)$ symmetry. 
 
(3) The dimerized term 
\begin{equation}
	\begin{aligned}
